...
* ## Uber: Ottimizzazione delle Promozioni e Ritenzione degli Utenti
  ...
  I data scientist di Uber hanno implementato modelli di Uplift Modeling basati su reti neurali Multi-Task. Nello specifico, hanno integrato e reso open-source l'architettura DragonNet. La rete ha una base condivisa che apprende una rappresentazione dell'utente (crhttps://gemini.google.com/app/ee3024598ce79bf1#:~:text=Vedi%20il%20codice%20di%20DragonNet%20su%20GitHub%20(Uber/CausalML)onologia viaggi, zona, livello di insoddisfazione) e si dirama in task/teste diverse per prevedere l'esito (se l'utente abbandona o meno) con o senza la promozione, calcolando l'effetto causale netto condizionale (CATE).
  ### Fonti
